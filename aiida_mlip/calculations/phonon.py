...
class Phonons(BaseJanus):  # numpydoc ignore=PR01
    """
    Calcjob implementation to run Phonon calculations using mlips.
    ...
    def prepare_for_submission(
        ...
        codeinfo.cmdline_params = [
            ...
            *codeinfo.cmdline_params[1:],
            #"--out",  # janus-core does not like the --out flag but I am keeping this incase I need to reinstate later
            #xyz_filename,
